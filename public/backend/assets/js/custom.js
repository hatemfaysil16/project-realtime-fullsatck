...
*************************/
    ...
    *************************/
    ...
    POTENZA.descriptioneditor = function() {
    ...
    POTENZA.specialtyeditor = function() {
        if ($('#specialty').exists()) {
            $('#specialty').summernote({
                height: 300, // set editor height
                minHeight: null, // set minimum height of editor
                maxHeight: null, // set maximum height of editor
                focus: true // set focus to editable area after initializing summernote
    ...
    POTENZA.experienceeeditor = function() {
    ...
    POTENZA.cert_noeditor = function() {
        if ($('#cert_no').exists()) {
            $('#cert_no').summernote({
                height: 300, // set editor height
                minHeight: null, // set minimum height of editor
    ...
    POTENZA.certificationeditor = function() {
    ...
    POTENZA.fullDescriptioneditor = function() {
        if ($('#fullDescription').exists()) {
    ...
    ****************************************************/
    ...
    $document.ready(function() {
        POTENZA.counters(),
            ...
            POTENZA.descriptioneditor(),
            POTENZA.specialtyeditor(),
            POTENZA.education(),
            POTENZA.experienceeeditor(),
            POTENZA.colorpicker(),
        ...
        POTENZA.cert_noeditor();
        POTENZA.certificationeditor();
        POTENZA.fullDescriptioneditor();
        POTENZA.bodyeditor();
