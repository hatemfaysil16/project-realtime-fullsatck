            ...
            success: function(response) {
                ...
                $.each(response.AllData, function(key, item) {
                    ...
                    if (response.LocalizationCurrent == 'en') {
                        var question = item.question.en;
                    } else if (response.LocalizationCurrent == 'ar') {
                        var question = item.question.ar;
                    }

                    if (response.LocalizationCurrent == 'en') {
                        var answer = item.answer.en;
                    } else if (response.LocalizationCurrent == 'ar') {
                        var answer = item.answer.ar;
                    }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status == 404) {
                    ...
                    if (response.LocalizationCurrent == 'en') {
                        var question = response.dataFind.question.en;
                    } else if (response.LocalizationCurrent == 'ar') {
                        var question = response.dataFind.question.ar;
                    }


                    if (response.LocalizationCurrent == 'en') {
                        var answer = response.dataFind.answer.en;
                    } else if (response.LocalizationCurrent == 'ar') {
                        var answer = response.dataFind.answer.ar;
                    }


                    $('#question_s').val(question);
                    $('#answer_s').val(answer);
